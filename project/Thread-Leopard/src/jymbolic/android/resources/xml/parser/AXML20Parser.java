...
import jymbolic.android.resources.xml.AXmlComplexValue;
import jymbolic.android.resources.xml.AXmlConstants;
import jymbolic.android.resources.xml.AXmlNamespace;
import jymbolic.android.resources.xml.AXmlNode;
import jymbolic.android.resources.xml.AXmlComplexValue.Unit;
			...
			if (tname == null || tname.isEmpty()) {
				...
				if (tname == null) {
					try {
						...
						// Without a name, we cannot really carry on:SootClassNotFound
						return;
					}
				}
			} else
