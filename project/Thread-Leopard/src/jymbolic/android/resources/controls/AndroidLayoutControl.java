 ...
 *
 */
public class AndroidLayoutControl {
	...
	void handleAttribute(AXmlAttribute<?> attribute, boolean loadOptionalData) {
		...
		if (attrName.equals("id")
				&& (type == NodeVisitor.TYPE_REFERENCE || attribute.getType() == NodeVisitor.TYPE_INT_HEX)) {
			id = (Integer) attribute.getValue();
		} else if (isActionListener(attrName) && type == NodeVisitor.TYPE_STRING
